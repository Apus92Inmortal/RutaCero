...
const variants = {
  ...
  secondary: "bg-white text-primary ring-1 ring-line hover:bg-surface focus-visible:ring-primary/20",
  success: "bg-success text-primary hover:bg-success/85 focus-visible:ring-success/30",
